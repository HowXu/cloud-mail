const en = {
    ...
    change: 'Change',
    changePwdBtn: 'Change',
    unionReceive: 'Union Receive',
    unionReceiveDesc: 'Inbox will also read mail sent to these addresses. Replies still use your current address',
    unionReceivePlaceholder: 'Add same-domain address',
    username: 'Username',
    password: 'Password',
